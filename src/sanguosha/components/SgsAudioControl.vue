...
.sgs-audio__panel { position: absolute; z-index: 92; right: 0; top: calc(100% + 8px); width: 310px; padding: 16px; border: 1px solid #496258; border-radius: 16px; background: #10251f; color: #e9e1ca; box-shadow: 0 18px 50px rgba(0, 0, 0, .65); }
...
.sgs-audio__panel header button { width: 30px; height: 30px; padding: 0; border: 1px solid #3b564d; border-radius: 50%; background: #18342c; color: #e8dbc0; cursor: pointer; font-size: 22px; line-height: 1; }
.sgs-audio__block, .sgs-audio__toggle { padding: 12px 0; border-top: 1px solid #2a443b; }
...
.sgs-audio__heading b, .sgs-audio__toggle b { color: #c4d0cc; font-size: 12px; }
.sgs-audio__heading em { margin-left: auto; color: #d9bd6d; font-size: 11px; font-style: normal; }
.sgs-audio__toggle > span:first-child { display: grid; flex: 1; gap: 2px; }
.sgs-audio__toggle small { color: #9d8055; font-size: 9px; }
...
.sgs-audio__switch i { position: absolute; inset: 0; border-radius: 99px; background: #3a5049; transition: background .2s ease; box-shadow: inset 0 0 0 1px rgba(255, 255, 255, .04); }
...
.sgs-audio__switch input:checked + i { background: #d5b652; }
...
.sgs-audio__slider { width: 100%; height: 18px; margin: 0; accent-color: #d8b95f; cursor: pointer; }
...
@media (max-width: 620px), (pointer: coarse) {
  ...
  .sgs-audio__panel { position: fixed; z-index: 92; left: 0; right: 0; top: auto; bottom: 0; width: auto; padding: 0 18px calc(20px + env(safe-area-inset-bottom)); border-right: 0; border-bottom: 0; border-left: 0; border-radius: 20px 20px 0 0; background: #0c211b; animation: sgs-audio-up .24s ease; }
  .sgs-audio__panel header { min-height: 62px; margin: 0 -18px 12px; padding: 0 18px; border-bottom: 1px solid #1d352d; }
  .sgs-audio__panel header strong { color: #f3d67c; font-size: 21px; }
  .sgs-audio__panel header button { border: 0; background: transparent; color: #8ba49c; font-size: 28px; }
  .sgs-audio__block { padding: 0 0 14px; border: 0; }
  .sgs-audio__heading, .sgs-audio__toggle { min-height: 62px; padding: 0 16px; border: 1px solid #355249; border-radius: 15px; background: #102a22; }
  ...
  .sgs-audio__heading em { margin: 0; color: #82978f; font-size: 12px; }
...
@media (orientation: landscape) and (max-height: 500px) {
  .sgs-audio__panel { left: 50%; right: auto; bottom: auto; top: 50%; width: min(480px, 82vw); padding: 0 14px 14px; border: 1px solid #355249; border-radius: 16px; transform: translate(-50%, -50%); animation: none; }
