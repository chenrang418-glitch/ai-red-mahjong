...
@keyframes sgs-dodge { 0% { opacity: 0; transform: translate(-50%,-50%) scale(.8); } 25% { opacity: 1; transform: translate(-160%,-50%) scale(1.05); } 55% { transform: translate(40%,-50%) scale(1.05); } 78% { transform: translate(-90%,-50%) scale(1); } 100% { opacity: 0; transform: translate(-50%,-50%) scale(.95); } }
...
@keyframes sgs-nullify { 0% { opacity: 0; transform: translate(-140%,-50%) scale(.85); } 40% { opacity: 1; transform: translate(-50%,-50%) scale(1.16); } 62% { transform: translate(-50%,-50%) scale(.98); } 100% { opacity: 0; transform: translate(40%,-50%) scale(.9); } }
@keyframes sgs-strike { 0% { opacity: 0; transform: translate(-50%,-40%) scale(.6); } 18% { opacity: 1; transform: translate(-50%,-58%) scale(1.3); } 32% { transform: translate(-54%,-58%) scale(1.18); } 46% { transform: translate(-46%,-58%) scale(1.18); } 100% { opacity: 0; transform: translate(-50%,-100%) scale(1); } }
