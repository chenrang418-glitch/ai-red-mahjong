  ...
  skills: [
    {
      id: HOUXIAO,
      name: '齁笑',
      description: '出牌阶段限一次，你可以令一名有手牌的其他角色选择一项：与你各摸一张牌，然后与你随机交换一张手牌；或展示一张手牌，你猜其余手牌中是否有与之同色的牌，猜对你摸两张牌，猜错其摸一张牌（其仅有一张手牌时不能选此项）。',
    },
    {
      id: PENGFU,
      name: '捧腹',
      description: '每回合限一次，一名其他角色于其出牌阶段使用的第二张牌结算后，你可以令其选择一项：摸一张牌，然后其于此阶段再使用牌则你摸一张牌，否则其于此阶段结束时弃置一张牌；或其弃置一张牌，然后你摸一张牌。',
    },
  ],
}
